...
CROSS="${TARGET_OUT}/toolchain/bin/arm-linux-gnueabi-"
...
#-----------------------------------------------------------------------------------------
CPPFLAGS="-Os --sysroot=$SYSROOT -fPIC -I$STAGING/usr/include -I$STAGING/usr/lib/include -DFORBID_TWOCLICKS_FLING"
