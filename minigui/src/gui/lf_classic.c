/*
** $Id: lf_classic.c 13435 2010-09-02 07:39:03Z xhmao $
**
...
static int calc_vscroll_area(HWND hWnd, int which, RECT* we_area)
{
    ...
    switch (which) {
        case HT_VSCROLL:
            ...
            we_area->bottom = we_area->top + win_h;
            return 0;
        ...
        case HT_SB_VTHUMB:
            ...
            we_area->top = border + cap_h + menu_h + scrollbar
                         + sbar_info->barStart;
#else
            we_area->top = border + cap_h + menu_h + sbar_info->barStart;
#endif
                ...
                { 
                    ...
                    old_brush_color = SetBrushColor(hdc, 
                            RGBA2Pixel(hdc,GetRValue(color_3d),
                                ...
                                GetAValue(color_3d)));
#else
					old_brush_color = SetBrushColor(hdc, RGBA2Pixel(hdc, 0x29, 0x29, 0x29, 0xFF) );
#endif
                    FillBox(hdc, rect.left, rect.top, RECTW(rect), RECTH(rect));
                    SetBrushColor(hdc, old_brush_color);
                }
