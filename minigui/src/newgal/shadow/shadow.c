/*
 **  $Id: shadow.c 13706 2011-01-05 10:31:47Z xbwang $
 **  
...
static GAL_VideoDevice *SHADOW_CreateDevice(int devindex)
{
    ...
    device->VideoSync = SHADOW_VideoSync;
...
static void* task_do_update (void* data)
{
    ...
    prctl(PR_SET_NAME, "GUIShadowEngineTaskUpdate", 0, 0, 0);
